    ...
    return (
        <div className="card">
            ...
            <div className="card-body" style={{ height: props.Height - 50 }}>
                <EventSearchPreviewD3Chart EventID={props.EventID} MeasurementType='Voltage' DataType='Trending' Width={svgWidth} Height={svgHeight / 2} />
                <EventSearchPreviewD3Chart EventID={props.EventID} MeasurementType='Current' DataType='Trending' Width={svgWidth} Height={svgHeight / 2} />
                <EventSearchPreviewD3ChartAxis EventID={props.EventID} Width={props.Width} Height={25} DataType='Trending'/>
            </div>
        </div>
    )
}