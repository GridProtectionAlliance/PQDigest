...
export const ESRIMap2: React.FunctionComponent<{ DateTime: string, Tolerance: number, ToleranceUnit: string, Radius: number, Strikes: any[], Width: number, Height: number }> = (props) => {
    ...
    return (
        <div className="card">
            ...
            <div className="card-body" style={{ padding: 0}}>
                ...
                <Map center={[35, -85]} zoom={7} style={{ height: props.Height - 50, width: props.Width - 12 }} >
                    {/*
                        <TileLayer
...
export default class ESRIMap extends React.Component<{ DateTime: string, Tolerance: number, ToleranceUnit: string, Radius: number, Strikes: any[], Width: number, Height: number  }, { Results: any, FaultInfo: Array<{ StationName: string, Inception: number, Latitude: number, Longitude: number, Distance: number, AssetName: string }>, Window: number }, {}>{
    map: leaflet.Map;
        ...
        return (
            <div className="card">
                ...
                <div className="card-body">
                    <div id="map" style={{ height: this.props.Height - 90, width: this.props.Width - 40, padding: 5, border: 'solid 1px gray' }}>
                    ...
                    <div style={{ maxHeight: window.innerHeight * 0.3 - 45, overflowY: "auto" }} hidden>
